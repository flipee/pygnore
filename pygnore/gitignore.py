...
class Gitignore:
    ...
    def stack(self, value):
        ...
        self._stack = sorted(set(self._raw_stack))
    ...
    def read(self, current=False):
        ...
        if self.exist:
            ...
            templates = compile(r"^### ([\w+-]+) ###$", MULTILINE)
            occurrences = {
                i.lower()
                for i in templates.findall(gitignore_content)
